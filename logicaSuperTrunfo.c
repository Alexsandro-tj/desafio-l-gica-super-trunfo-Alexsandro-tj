...
int main()
{
    ...
    int statusCarta = 1;
    int menuComparacao, menuComparacao2;

    // Menu de Escolha de Comparação do primeiro atributo
    ...
    // Menu de Escolha de Comparação do segundo atributo
    printf("*** ATENÇÃO VOCÊ NÃO PODE ESCOLHER O MESMO ATRIBUTO! ***\n");
